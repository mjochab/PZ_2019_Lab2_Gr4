...
public class HarmonogramController implements Initializable {
    ...
    ObservableList<String> listaGodzin = FXCollections.observableArrayList(godzinyZajec);
    ObservableList<String> listaZajec = FXCollections.observableArrayList(dniZajec);
    d_box_godz.setItems(listaGodzin);
    d_box_dzien.setItems(listaZajec);
    }
